...
run_hsicbt -cfg config/resconv-hsicbt.yaml   -mf hsic_weight_resconv_fmnist.pt -dc fmnist
...
run_hsicbt -cfg config/resconv-hsicbt.yaml   -mf hsic_weight_resconv_cifar10.pt -dc cifar10
